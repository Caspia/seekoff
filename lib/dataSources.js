...
const MAX_READ_LINES = 256;
/**
 * Given an object parsed from XML, clean up the type by converting strings
 * to numbers, and deleting unused fields.
 ...
 */
function readFile(filePath, type, action, onProgress, onDataDone) {
  let linesRead = 0;
