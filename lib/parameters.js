...
const preferenceDefaults = {
  ...
  tagsToInclude: 'javascript node.js express passport mongoose html html5 bootstrap mocha electron pug jade reactjs react-jsx react-router redux',
...
parameters.tagsToInclude = process.env.ELASTIC_TAGS_TO_INCLUDE || parameters.tagsToInclude;
...
parameters.xmlFilePath = process.env.ELASTIC_XML_FILE_PATH || parameters.xmlFilePath;
